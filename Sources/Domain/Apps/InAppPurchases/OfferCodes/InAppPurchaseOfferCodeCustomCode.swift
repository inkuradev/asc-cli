public struct InAppPurchaseOfferCodeCustomCode: Sendable, Equatable, Identifiable {
...
extension InAppPurchaseOfferCodeCustomCode: Codable {
...
extension InAppPurchaseOfferCodeCustomCode: AffordanceProviding {
    public var affordances: [String: String] {
        var cmds: [String: String] = [
            "listCustomCodes": "asc iap-offer-code-custom-codes list --offer-code-id \(offerCodeId)",
        ]
        if isActive {
            cmds["deactivate"] = "asc iap-offer-code-custom-codes update --custom-code-id \(id) --active false"
        }
        return cmds
    }
}
